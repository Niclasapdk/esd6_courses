...
% Note: lasso function automatically includes intercept, so we remove the first column of ones
% For complete implementation without the toolbox, see alternative approach below

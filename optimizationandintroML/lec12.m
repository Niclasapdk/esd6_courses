...
X_bar =  %FILL THE MISSING CODE
Xc = %FILL THE MISSING CODE

% SVD to perform PCA: 
%FILL THE MISSING CODE (use svd function with matlab)

%The eigenvalues of the covariance matrix as a column vector
lambda        =  %FILL MISSING CODE
%Individual explained variance:
explained     = %FILL MISSING CODE
...
Xc_hat = %FILL MISSING CODE 
X_hat = %FILL MISSING CODE
